...
const ExperienceDetails = () => {
  ...
  return (
    <section id="1" className="space-y-10 md:space-y-14 my-16 mx-4 md:mx-8 lg:mx-16 bg-gray-950 bg-opacity-40 p-4 md:p-6 lg:p-8 rounded-2xl border border-gold">
      <div className="text-center">
        <h4 className="text-xl md:text-2xl font-bold mb-4 text-tantra-light uppercase">
          Um dia dedicado à reconexão
        </h4>
        <p className="text-sm md:text-base text-tantra-light">
