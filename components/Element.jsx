...
export default function Element() {
  return (
    <main className="relative flex flex-col items-center justify-center h-screen text-center px-4 md:px-8 lg:px-16">
      ...
      <p className="my-4 mx-8 text-lg md:text-3xl md:mx-60 font-extralight">
      ...
      <button
        className="animate-pulse text-yellow-500 font-semibold underline hover:text-white transition-colors duration-300"
        onClick={() => {
